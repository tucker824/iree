...
static void IREE_API_PTR iree_hal_module_wrapped_buffer_release(void* self,
                                                                void* ptr) {
  iree_vm_ref_object_release(self, iree_vm_ro_byte_buffer_get_descriptor());
}
...
IREE_VM_ABI_EXPORT(iree_hal_module_allocator_wrap_byte_buffer, riirii, r) {
  ...
  if (wrap_allowed) {
    ...
    release_allocator.alloc = NULL;
    release_allocator.free = iree_hal_module_wrapped_buffer_release;
    release_allocator.self = source;
    ...
    iree_vm_ref_object_retain(source, iree_vm_ro_byte_buffer_get_descriptor());
  } else {
